...
```bash
uv run python train_model.py --max-steps 1000   # run script
...
```bash
python experiments/ablations/run_ablations.py --ablation cross_attention
python experiments/ablations/run_ablations.py --ablation delta_loss
```
...
```bash
python experiments/benchmarks/synthetic_suite.py \
